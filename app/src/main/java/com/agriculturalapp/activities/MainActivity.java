...
public class MainActivity extends AppCompatActivity
    ...
    private Integer[] imageUrls={
            ...
            R.raw.treat,
            R.raw.shc2,
            R.drawable.production_main,
            R.drawable.horticulture_main,
            R.raw.govp};

    private Integer[] hindiTexts={
            R.string.crop_variety_recommeneder_hi,
            R.string.crop_yield_hi,
            R.string.crop_production_card_title_hi,R.string.treatment_card_title_hi,
            R.string.storage_card_title_hi,
            R.string.survey_card_title_hi,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent[] links={
                ...
                new Intent(MainActivity.this, CropYieldPrediction.class),
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.bazar_rates_nav) {
           ...
           startActivity(new Intent(MainActivity.this,sunmain.class));
            ...
            String uriText = "mailto:" + Uri.encode("jyotigupta0225@gmail.com") + "?subject=" +
